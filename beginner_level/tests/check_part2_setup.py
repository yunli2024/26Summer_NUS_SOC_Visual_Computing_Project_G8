...
def main() -> int:
    ...
    try:
        ...
        right_turn_small_face = np.asarray([(172, 150, 96, 96)], dtype=np.int32)
        selected = detector._select_face(right_turn_small_face)
        results.append(check("Right-turn shrunken feature face rejected", selected is None))
