...
PROJECT_DIR = PART_TWO_DIR.parent
FACE_MODELS_DIR = PROJECT_DIR / "resources" / "face_models"
if str(PART_TWO_DIR) not in sys.path:
    sys.path.insert(0, str(PART_TWO_DIR))
...
class ExpressionFeatureExtractor:
    ...
    def __init__(self, image_size: int = 192, center_inset: float = 0.08) -> None:
        ...
        self.detector = FaceLandmarkDetector(
            FACE_MODELS_DIR / "haarcascade_frontalface_default.xml",
            FACE_MODELS_DIR / "lbfmodel.yaml",
        )
