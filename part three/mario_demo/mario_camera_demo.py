...
PART_THREE_DIR = DEMO_DIR.parent
ASSET_DIR = DEMO_DIR / "assets"
MODEL_PATH = PART_THREE_DIR / "yolov8n-pose.pt"
SAMPLE_VIDEO = PART_THREE_DIR / "dance_example_1.mp4"
os.environ.setdefault("YOLO_CONFIG_DIR", str(DEMO_DIR / ".yolo_config"))
if str(PART_THREE_DIR) not in sys.path:
    sys.path.insert(0, str(PART_THREE_DIR))
