...
```powershell
D:\miniconda3\envs\vc_sws3026\python.exe part2_beginner\tests\check_part2_setup.py
```
...
```powershell
D:\miniconda3\envs\vc_sws3026\python.exe part2_beginner\src\run_face_landmarks.py
```

CLAHE preprocessing mode:

```powershell
D:\miniconda3\envs\vc_sws3026\python.exe part2_beginner\src\run_face_landmarks.py --clahe
```
...
- Screenshots: `part2_beginner/outputs/screenshots/`
- Robustness results: `part2_beginner/outputs/robustness_results/`
- Logs: `part2_beginner/outputs/logs/`
